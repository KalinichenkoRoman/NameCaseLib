# NameCaseLib
NameCaseLib всем привет, хочу представить вам данную библиотеку - PHP5,приятного пользования, возможно скоро будут следующие обновления библиотнка предназначенна для автоматического склонения ФИО в русском и украинском языках. Уникальная особенность состоит в том, что библиотека содержит одинаковые методы для работы с ФИО на русском и украинском языках.
